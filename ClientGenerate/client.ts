...
export class AuthClient {
    ...
    protected processRegister(response: Response): Promise<RegisterResponseModel> {
        ...
        if (status === 200) {
            ...
            result200 = RegisterResponseModel.fromJS(resultData200);
            return result200;
            });
...
export class RegisterResponseModel implements IRegisterResponseModel {
    accessToken!: string;

    constructor(data?: IRegisterResponseModel) {
        if (data) {
    ...
    static fromJS(data: any): RegisterResponseModel {
        data = typeof data === 'object' ? data : {};
        let result = new RegisterResponseModel();
        result.init(data);
        return result;
    }
